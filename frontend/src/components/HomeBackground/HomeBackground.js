...
const HomeBackground = () => {
  ...
  return (
    <div className="home-background">
      ...
      <div className="bg parallax sky" style={{ transform: `translate3D(0px, -${scroll * .2}px, 0px)`}} />
      <div className="bg parallax mountains-back" style={{ transform: `translate3D(0px, -${scroll * .3}px, 0px)`}} />
