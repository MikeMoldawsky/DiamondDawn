...
const HomeBackground = () => {
  ...
  return (
    <div className="home-background">
      ...
      <div className="bg parallax mountains-front" style={{ transform: `translate3D(0px, -${scroll * .5}px, 0px)`}} />
      <div className="bg parallax black-box" style={{ transform: `translate3D(0px, -${scroll * .5}px, 0px)`}}/>
    </div>
  );
};
