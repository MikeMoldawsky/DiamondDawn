...
const InviteStatus = () => {
  ...
  const renderContent = () => {
    if (invite.opened) return (
      <>
        <div>You have opened your invitation and didn't get your entry ticket</div>
        <Countdown date={invite.expires} text={["Expires in"]}
    ...
    return (
      <div>Your invitation is pending</div>
    )
  }
