...
const GoToOpensea = () => {
  ...
  const nextActionableName = NFT_NAME_BY_STAGE[isStageActive ? systemStage : (systemStage + 1)]
  ...
  return (
    <div className="center-aligned-column goto-opensea">
      ...
      <div className="left-centered-aligned-column">
        ...
        <div className="text">Don't worry, you can still participate in Diamond Dawn by purchasing a <b>{nextActionableName}</b> NFT in the open market</div>
      </div>
      <OpenseaLink>
