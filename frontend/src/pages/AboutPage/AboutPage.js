        ...
        <div className="inner-page">
          ...
          <div className="center-aligned-column journey">
            ...
            <div className="journey-step">
              ...
              <div className="text">
                The final step is unique, and that's why you’ll have a longer
                time window to decide about your actions. <br />
                <br />
          ...
          <div className="center-aligned-column team">
            ...
            <div className="text our-team">
              ...
              Internet’s survival.
              <br />
              <br /> We look forward to the day when the robust technology
            ...
            <div className="team-members">
              <div className="team-member">
                ...
                <div className="text">
                  An entrepreneur with a background in software engineering,
                  Mike fell under the magic of NFT technology in 2016. An early
                  adopter by nature, Mike foresaw that the disruptive tech
                  behind web3 and NFTs will become a transforming force for most
                  industries, digital communities, and how we consume content on
                  the whole. He has since vowed to become an active member and
                  architect of the crypto revolution, making it his life’s
                  mission to push forward decentralized technology to a state
                  where it creates REAL LIFE impact that will, in turn, change
                  society at large.
                </div>
              </div>
              <div className="team-member">
                ...
                <div className="text">
                  ...
                  prolific in various artistic styles that he continues to
                  develop - from energetic concert visuals that are tightly
                  synced with the music, to creating overly ambitious, full CG
                  short films, and mesmerizing animations. David has also had
                  several major successes in web3, including being part of the
                  Pak's ASH 2 drop, creating two NFTs for Beeple x Madonn a (one
                  of which sold for $346,000) and a collab with famous artist
                  Jia Alli on a piece entitled "The Road Ahead", which sold at
                  Sotheby’s. David’s mission as an artist is not only to grow
                  the NFT community, but also to help up-and-coming 3D artists
                  gain traction in the field.
                </div>
              </div>
              <div className="team-member">
                <AccountCircleIcon />
                ...
                <div className="text">
                  Born to diamond merchants, Aviva was exposed, from a young
                  age,  to both the harsh world of trade and negotiation and the
                  fascinating world of exquisite beauty contained within the
                  stones themselves. A world where, to this day, deals are
                  closed not with a contract, but with a handshake and the word
                  ‘luck’.  A highly-respected name in the world of diamonds, the
                  Moldawsky family has supplied stones to Tiffany’s, Sterling,
                  JC Penny, and more of  the largest firms in the world. As a
                  diamond designer, Aviva helps her clients choose the rough
                  stone, knowing which stone will yield the most desirable end
                  result, and oversees the entire design process that will best
                  fit her customer’s personality and style - from raw material
                  all the way to the box in which it is delivered.
                </div>
              </div>
              <div className="team-member">
                <AccountCircleIcon />
