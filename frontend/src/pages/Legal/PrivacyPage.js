      ...
      <div className="start-start-aligned-row">
        ...
        <div>
          <p>
            ...
            <ul>
              <li>
                ...
                into a Jewelry artwork through the Website.{" "}
              </li>
              <li>
                <b>
          ...
          <p>
            ...
            address{" "}
            <a href="mailto:tweezers@tweezers.art">tweezers@tweezers.art</a>, in
            order to receive information concerning the review performed by Us.
            This is so You can conclude that We may process the Personal Data
            about You on account of such processing being necessary for the
      ...
      <div className="start-start-aligned-row">
        ...
        <div>
          <p>
            ...
            <a href="mailto:tweezers@tweezers.art">tweezers@tweezers.art</a>, in
            which case We shall cease to process Personal Data about You for
            direct marketing purposes.{" "}
          </p>
        </div>
      </div>
      <div className="start-start-aligned-row">
        ...
        <div>
          <p>
            ...
            <a href="mailto:tweezers@tweezers.art">tweezers@tweezers.art</a> or
            by clicking the unsubscribe option in any marketing material sent to
            You. You can withdraw Your consent from receiving marketing
            materials via push notifications in Your mobile device’s settings
            page.
          </p>
        </div>
      </div>
