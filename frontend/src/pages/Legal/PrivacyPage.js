    ...
    <div className="page tnc-page">
      <div className="inner-page">
        ...
        <div className="start-start-aligned-row">
          ...
          <div>
            <p>
              ...
              <b>“You”</b>, <b>“Your”</b> or <b>“User”</b>) Personal Data and
              Your privacy. This privacy policy (the <b>“Policy”</b>) provides
              You information regarding the types of information that We collect
              about the Members of the Diamond Dawn community operated on Our
              Website diamonddawn.art (the <b>“Website”</b>) and the services
              provided as part of the community (the <b>“Services”</b>), how We
              use it, store it, process it and share it with third parties.
            </p>
            <p>
            ...
            <p>
              ...
              Capitalized terms in this Policy shall have the meanings ascribed
          ...
          <div>
            <p>
              ...
              <ul>
                ...
                <li>
                  When You interact with Us via Our communication channels.
                </li>
              </ul>
            </p>
            <p>
              <b>
                Blockchain information – since part of the Services are ran on
                the blockchain network, it is important that You will be aware
                that activity made on blockchain network (ether and other
                digital assets) are not truly anonymous. We, and any others who
                can match Your public blockchain network address to other
                Personal Data about You, may be able to identify You from a
                blockchain transaction because, in some circumstances, Personal
                Data published on a blockchain (such as Your blockchain network
                address and IP address) can be correlated with Personal Data
                that We and others may have. Furthermore, by using data analysis
                techniques on a given blockchain network, it may be possible to
                identify other Personal Data about You.
              </b>
            </p>
          </div>
        </div>
        ...
        <div className="start-start-aligned-row">
          ...
          <div>
            <p>
              <u>Diamond-NFTs purchase data</u> – when You purchase a
              Diamond-NFT, We will gather Your social media page URL and your
              email address.
            </p>
          </div>
        </div>
        <div className="start-start-aligned-row">
          ...
          <div>
            <p>
              <u>Diamond-NFTs redemption data</u> – when You redeem a Diamond
              NFT by purchasing the Art associated with the Diamond-NFT, You
              will be requested to provide Us with Your email address, full name
        ...
        <div className="start-start-aligned-row">
          ...
          <div>
            <p>
              <u>Usage information and log files</u> - as You navigate through
              and use the Website, We may also use automatic data collection
              ...
              order to provide Our Service and make it more useful to You, and
              it includes online activity log, IP address, mobile device ID,
              blockchain address, browser type, operating system, country
              location, wallet type, date and time stamps, web and mobile
              page(s) visited, clickstream data, configuration data and software
              crash reports. Some of this information may not identify You
              personally, and therefore not constitute Personal Data.{" "}
            </p>
          </div>
        </div>
        <div className="start-start-aligned-row">
          ...
          <div>
            <p>
              ...
              content of Your communication with Us and Your interaction with
              the content that We shall send You.
            </p>
          </div>
        </div>
        <div className="start-start-aligned-row">
          ...
          <div>
            <p>
              ...
              aggregated and anonymized data relating to Our Users and the
              Service for analytical purposes, including business development
              and services improvements. Aggregated data is derived from
              Personal Data but in its aggregated form it does not relate to or
              identify any particular individual or any specific User’s data.
              This data is used to understand Our users’ base and to develop,
        ...
        <div className="start-start-aligned-row heading">
          <div>5.</div>
          <div>
            The Purposes Of The Processing Of Personal Data And Their Legal
            Basis
          </div>
        </div>
        <div className="start-start-aligned-row">
          ...
          <div>
            <p>
              <p>
                ...
                purposes outlined in this section and according to the
              ...
              <ul>
                ...
                <li>
                  ...
                  By way of example, for the purpose of improving Our Services
                  We will use the data concerning errors and malfunctions that
                  You will overcome while using the Website; in addition, We may
                  use certain Personal Data for the exercise or defence of legal
                  claims.
                </li>
                <li>
                  <p>
                  ...
                  <p>
                    Where the legal basis for the processing of the Personal
                    Data about You is consent, You may at any time withdraw Your
                  ...
                  <p>
                    ...
                    form intended to be provided to You.
                  </p>
                </li>
                <li>
                  <b>
                  ...
                  We may need to use some of the Diamond-NFTs redemption data
                  for compliance with anti-money laundering regulation
                  applicable to Us.{" "}
                </li>
              </ul>
            </p>
            ...
            <p>
              ...
              Personal Data about You and the legal basis for any such
              processing:
            </p>
            <table>
              <thead>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      ...
                      instance, if We wish to update You of new Services
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      ...
                      order to make accessible to You a more customized content
                      or services.
                    </p>
                  </td>
                  <td>5</td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      In as much as You agree to receive marketing materials
                      from Us, We will send You, via the means of communication
                      You consented to, marketing materials relating to Our
                      Services, whether in existence now or in the future,
                      whether similar to Our Services and whether different
                      ones, and/or products and services of third parties.
                    </p>
                    <p>
                      It is hereby clarified that You may withdraw Your consent
                      at any time, by clicking the unsubscribe button at bottom
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      ...
                      behavior, characteristics and interests; these materials
                      can be Ours or of third parties. For this purpose, We use
                ...
                <tr>
                  ...
                  <td>
                    <p>
                      <b>
                        In order to comply with any legal obligations or
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      ...
                      Services, as well as any errors and malfunctions reports.{" "}
                    </p>
                  </td>
                  <td>9</td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      ...
                      Users unless it is to fulfill an affirmative duty to
        ...
        <div className="start-start-aligned-row heading">
          <div>6.</div>
          <div>
            Your Right To Object To The Processing of Personal Data About You
        ...
        <div className="start-start-aligned-row">
          ...
          <div>
            <p>
              ...
              activities in ways that are compatible to Your needs and
              preference. This may include ads, offers and other sponsored
              content related to products and services of Ours or of third
              parties. For this purpose, We may use automated analysis
              techniques that provide Us with analysis and conclusions
        ...
        <div className="start-start-aligned-row">
          ...
          <div>
            <p>
              ...
              agreed to receive marketing materials from Us, as such materials
              can be tailored to offer You products and services which We think
        ...
        <div className="start-start-aligned-row">
          ...
          <div>
            <p>
              ...
              to the following email address: <MailToSupportLink />, in which
              case We shall cease to process Personal Data about You for direct
              marketing purposes.{" "}
            </p>
          </div>
        </div>
        <div className="start-start-aligned-row">
          ...
          <div>
            <p>
              In addition, You may withdraw Your consent from receiving
              ...
              address: <MailToSupportLink /> or by clicking the unsubscribe
              option in any marketing material sent to You. You can withdraw
              Your consent from receiving marketing materials via push
              notifications in Your mobile device’s settings page.
            </p>
          </div>
        </div>
        <div className="start-start-aligned-row">
          ...
          <div>
            <p>
              ...
              communications from Us, We may still communicate with You from
              time to time if We need to provide You with non-marketing
              information about Our Services or for other legitimate
        ...
        <div className="start-start-aligned-row">
          ...
          <div>
            <p>
              We may transfer Personal Data to entities that control Us,
              entities that are under Our control and/or to entities under
              common control or ownership with Us, as shall be from time to time
              (collectively the <b>“Group”</b>). Such entities may use the
              Personal Data to support the needs of the Group.{" "}
            </p>
          </div>
        </div>
        <div className="start-start-aligned-row">
          ...
          <div>
            ...
            <ul>
              <li>
                Storage and hosting providers, including cloud computing
        ...
        <div className="start-start-aligned-row">
          ...
          <div>
            <p>
              In addition, We may share Personal Data about You with the
              following third parties or for the following purposes:
            </p>
            <ul>
              ...
              <li>
                To fulfil Our legal or regulatory requirements or to comply with
                a court order.
              </li>
            </ul>
          </div>
        ...
        <div className="start-start-aligned-row">
          ...
          <div>
            <p>
              ...
              international organizations. In such circumstances, the Company
              shall take appropriate safeguards to ensure the protection of
              Personal Data about You and to provide that enforceable data
            ...
            <ol type="a">
              ...
              <li>
                ...
                clauses adopted by the EU Commission pursuant to Article
                46(2)(c) of the GDPR.
              </li>
            </ol>
            <p>
              You may request that the Company provide You with details
              concerning the safeguards employed by it to protect the Personal
        ...
        <div className="start-start-aligned-row">
          ...
          <div>
            <p>
              ...
              Personal Data is collected. We may retain Personal Data about You
              for longer periods, if We find it necessary to comply with legal
        ...
        <div className="start-start-aligned-row">
          ...
          <div>
            <p>
              ...
              disclosure, unauthorized modification, or unlawful destruction.
              However, any storage of Personal Data and especially, the transfer
              thereof via the internet cannot be fully secured, and therefore We
              cannot promise absolute protection of Your Personal Data.{" "}
            </p>
          </div>
        </div>
        ...
        <div className="start-start-aligned-row">
          ...
          <div>
            <p>
              ...
              Data, and We will not be liable for any indirect, incidental,
              consequential, or punitive damages relating to the use or release
              of Personal Data about You including, but not limited to,
              disclosure of Personal Data due to errors in transmission,
        ...
        <div className="start-start-aligned-row">
          ...
          <div>
            <p>
              ...
              third parties. Other websites and applications may also reference
              or link to Our Website. We do not control such websites and
              applications, nor the collection and/or processing of Personal
              Data about You by such websites and applications, and thus We are
              not responsible for their privacy practices. This Policy does not
              apply to any actions taken via such websites and/or applications.
            </p>
          </div>
        </div>
        <div className="start-start-aligned-row">
          ...
          <div>
            <p>
              ...
              policies prior to using such websites and/or applications and
              prior to disclosing any Personal Data about You.
            </p>
          </div>
        </div>
        ...
        <div className="start-start-aligned-row">
          ...
          <div>
            <p>
              ...
              collected by Us, to ask to review such data, to rectify the
              Personal Data if applicable and to erase the Personal Data no
        ...
        <div className="start-start-aligned-row">
          ...
          <div>
            <p>
              We will fulfil Your right to receive information about how
              Personal Data about You is processed by Us; to rectify any
              inaccuracy in Your Personal Data; to erase Your Personal Data
              processed and stored by Us; to restrict the processing of Personal
              Data about You or object to such processing if applicable under
              the circumstances; and the right to receive the Personal Data
              about You, which You have provided to the Company, in a structured
        ...
        <div className="start-start-aligned-row">
          ...
          <div>
            <p>
              We may reject Your requests where they harm the rights and
              freedoms of others or where We must do so to comply with legal
              requirements applicable to Us. We may also charge a reasonable fee
              where applicable.
            </p>
          </div>
        </div>
        <div className="start-start-aligned-row">
          ...
          <div>
            <p>
              You will also have the right to lodge a complaint with a
              supervisory authority established by a Member State to protect the
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              <td>
                ...
                <p>
                  ...
                  necessary to complete Our legal obligation to You to provide
                  the Services or otherwise protect Our legal rights; to comply
                  with an existing legal obligation; or use Your Personal Data,
            ...
            <tr>
              <td>
                You may designate an authorized agent to make a request under
                the CCPA on Your behalf. To do so, You need to provide the
                authorized agent written permission to do so and the agent will
                need to submit to Us a proof that such agent has been authorized
                by You. We will also require that You verify Your own identity,
                as explained below.
              </td>
              <td>
                Right to designate an authorized agent to submit CCPA requests
                on Your behalf
              </td>
              <td>4</td>
            </tr>
        ...
        <div className="start-start-aligned-row">
          ...
          order to verify Your identity prior to allowing You to exercise Your
          rights.
        </div>
        <div className="start-start-aligned-row heading">
          <div>14.</div>
        ...
        <div className="start-start-aligned-row">
          ...
          <div>
            <p>
              We may amend, from time to time, the terms of this Policy.
              Whenever We amend this Policy, We will notify You of such
              amendments by publishing the updated Policy on the Website. In
              addition, when We make significant amendments to this Policy, We
              will strive to inform You about such amendments via means of
              communication We believe are reasonably appropriate to inform You
              of such amendments and by publishing a notice about such
              amendments on the Website. Unless stated otherwise, all amendments
              will enter into force upon publication of the updated Policy on
              Our Website or on the designated page in the Website.
            </p>
          </div>
        </div>
        <Footer />
