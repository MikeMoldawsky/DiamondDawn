...
export const toggleIsMintOpenApi = async (timestamp) => {
  try {
    const { data } = await axios.post(`/api/toggle_mint_open`, { timestamp });
    return data || {};
  } catch (e) {
    return {};
  }
...
export const createInvitationApi = async (invitation, count) => {
