...
const INVITATION_COLUMNS = [
  ...
  { field: "identifier", headerName: "Twitter/Email", width: 200, editable: true, showIfRequest: true },
  {
    field: "address",
    headerName: "Address",
    width: 400,
  ...
  { field: "location", headerName: "Location", width: 150, showIfRequest: true },
  { field: "note", headerName: "Notes", width: 300, flex: 1, editable: true, showIfRequest: true },
];
...
const ApproveButton = ({ inviteId, onApprove }) => {
  ...
  return (
    <GridActionsCellItem
      icon={
        <FontAwesomeIcon icon={faCheck} onClick={approve} />
      }
      label="Edit"
      className="textPrimary"
      color="inherit"
